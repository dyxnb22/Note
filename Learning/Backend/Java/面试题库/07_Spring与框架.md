...
| 文档 | 负责的问题 | 主要内容 |
| --- | --- | --- |
| [Spring 核心](09_Spring核心.md) | 对象如何创建、组装和增强 | IoC、DI、Bean、AOP、事务、扩展点 |
| [Spring Web 与 Boot](10_SpringWeb与Boot.md) | HTTP 应用如何接入和启动 | Spring MVC、参数绑定、异常处理、自动配置、Starter |
| [Java 数据访问](08_Java数据访问.md) | Java 服务如何安全访问关系数据库 | JDBC、连接池、MyBatis、JPA、事务边界 |
| [Spring Cloud](11_SpringCloud.md) | 多服务如何发现、通信和治理 | 注册配置、OpenFeign、Gateway、负载均衡与容错 |
...
- Java 语言、反射和动态代理基础放 [Java](01_语言与运行时.md)。
