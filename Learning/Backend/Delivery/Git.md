...
<details>
<summary>版本控制有哪些类型？Git 和 SVN 的区别是什么？</summary>
	版本控制主要分为三类：
...
<details>
<summary>Git 的工作区、暂存区、本地仓库、远程仓库分别是什么？</summary>
	Git 常见的四个区域：
...
<details>
<summary>git add 和 git commit 分别做了什么？</summary>
...
<details>
<summary>git fetch 和 git pull 的区别是什么？</summary>
...
<details>
<summary>git merge 和 git rebase 的区别是什么？</summary>
...
<details>
<summary>git reset、git revert、git checkout/restore 有什么区别？</summary>
...
<details>
<summary>`git reset --soft / --mixed / --hard` 区别是什么？</summary>
...
<details>
<summary>如果提交已经推到远程，撤销应该怎么做？</summary>
...
<details>
<summary>误删了分支或 commit，还能找回来吗？</summary>
...
<details>
<summary>为什么会产生 merge conflict？</summary>
	两个分支修改了同一文件的同一区域，Git 无法自动判断保留哪一份，就会产生冲突。
</details>

<details>
<summary>冲突一般怎么解决？</summary>
	流程通常是：
...
<details>
<summary>rebase 冲突和 merge 冲突有什么区别？</summary>
...
<details>
<summary>origin 是什么？</summary>
	`origin` 只是远程仓库的默认别名，不是固定关键字，可以改成别的名字，但绝大多数仓库都使用 `origin`。
</details>

<details>
<summary>如何查看和管理远程仓库？</summary>
...
<details>
<summary>推送代码被拒绝，常见原因是什么？</summary>
	常见原因：
	- 远程分支有新提交，本地落后。
	- 没有权限。
	- 分支保护规则限制直接推送。
...
<details>
<summary>tag 和 branch 有什么区别？</summary>
	branch 是可移动指针，会随着新提交继续向前。
	tag 通常用于给某个固定版本打标记，例如 `v1.0.0`，默认不移动。
</details>

<details>
<summary>stash 是做什么的？</summary>
