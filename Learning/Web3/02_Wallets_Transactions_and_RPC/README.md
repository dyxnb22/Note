# 02_Wallets_Transactions_and_RPC

这个模块解释应用怎样与链交互，重点是钱包身份、交易生命周期、Gas 机制和 RPC 通信。
...
- [账户抽象与智能钱包](/Users/diaoyuxuan/Documents/Notes/Learning/Web3/02_Wallets_Transactions_and_RPC/账户抽象与智能钱包.md)
