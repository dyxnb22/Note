...
| 01 Agent | [simple_agent.py](./01_agent_basics/project/simple_agent.py) | [03_Agent架构与设计](../../../Agent/03_Agent架构与设计.md) |
...
| 04 评测 | [prompt_eval.py](./04_llm_evaluation/project/prompt_eval.py) | [09_Agent Eval实验方法](../../../Agent/09_Agent%20Eval实验方法.md) |
| 05 微调与推理 | [prepare_sft_dataset.py](./05_finetune_and_inference/project/prepare_sft_dataset.py) | [LLM 基础](../../LLM基础.md) |
| 06 生产系统 | [llm_gateway.py](./06_production_llm_system/project/llm_gateway.py) | [12_部署与生产化](../../../Agent/12_部署与生产化.md) |
...
| 10 可解释性与评测 | [eval_significance.py](./10_interpretability_and_evaluation/project/eval_significance.py) | [09_Agent Eval实验方法](../../../Agent/09_Agent%20Eval实验方法.md) |
