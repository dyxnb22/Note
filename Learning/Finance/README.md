...
| 模块 | 文档（篇数）| 待补充 |
|------|-----------|--------|
| 00_Foundations | ✅ 时间价值与贴现、复利与对数收益率、风险与收益的基本关系、机会成本与边际思维、概率直觉与统计基础（5 篇）| — |
| 01_Economics | ✅ 经济学十大核心概念、供给与需求、通货膨胀、利率机制、汇率机制、货币与信用、货币政策、财政政策、经济周期、失业与劳动力市场、市场效率与市场失灵（11 篇）| — |
...
| 09_Portfolio_and_Risk | ✅ 分散化与相关性、波动率与最大回撤、夏普比率与绩效指标、仓位管理、风险预算、再平衡（6 篇）| — |
