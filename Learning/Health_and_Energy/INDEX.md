...
这条主线用于建立可持续的身体与状态底盘，不追求短期硬扛，也不替代医疗诊断。
...
| 模块 | 主文档 | 重点 |
|---|---|---|
| 状态基础 | [精力管理比时间管理更底层](00_Foundations/精力管理比时间管理更底层.md) | 从上游状态解释效率和执行波动 |
| 睡眠恢复 | [睡眠为什么是第一优先级](01_Sleep_and_Recovery/睡眠为什么是第一优先级.md) | 睡眠对认知、情绪和恢复的影响 |
...
- [状态管理速查](00_Foundations/状态管理速查.md)
- [睡眠与恢复速查](01_Sleep_and_Recovery/睡眠与恢复速查.md)
...
1. 连续记录一至两周：睡眠时长与规律、白天精力、活动、饮食节律和压力。
2. 找最上游且最可改变的一个变量，只做一个低摩擦调整。
3. 比较趋势而不是单日感受；无改善时重新检查假设。
4. 忙碌期使用最低可持续版本，不用一次性补偿制造新的负担。
