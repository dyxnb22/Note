...
5. [后端测试体系](./Backend/Testing.md)、[系统设计](./Backend/Architecture/01_系统设计.md)、[DDD 与领域建模](./Backend/Architecture/02_DDD与领域建模.md)、[可靠性与一致性](./Backend/Architecture/04_可靠性与一致性.md)：形成验证与设计主线。
