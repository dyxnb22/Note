...
从与当前问题最接近的主题入口开始；目录边界和维护规则见 [维护规范](./00_Navigation/维护规范.md)。不要把本页或任何目录当成连续必修课。
...
1. 先处理真实问题；遇到知识缺口再进入相应主题。
2. 概念正文用于理解，不默认附带必须完成的练习；实践和项目负责运行与验证。
3. 格式、措辞和轻微重复不应打断当前学习；只在下次使用该主题时顺手整理。
4. 跨主题导航只链接稳定入口，局部拆分和重命名尽量留在主题内部。
