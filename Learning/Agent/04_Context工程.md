...
> **学习位置**：主线第 4 篇，读完 [Agent 架构与设计](./03_Agent架构与设计.md)。
>
> **职责边界**：本文负责当前请求的 Context 选择、排序、压缩、注入和预算；跨会话 Memory 见 [Memory 与状态管理](./Memory与状态管理.md)，工具权限见 [安全与可控性](./08_安全与可控性.md)，工具 schema 见 [Tool Calling](./02_Tool%20Calling.md)。
