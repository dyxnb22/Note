...
| `02-tools` | Tool、ToolNode、ReAct 闭环 | [02_Tool Calling](../../../02_Tool%20Calling.md) |
...
| `05-production` | interrupt、resume、流式事件 | [08_安全与可控性](../../../08_安全与可控性.md)、[12_部署与生产化](../../../12_部署与生产化.md) |
| `06-mcp` | MCP Server / Client、工具复用 | [MCP 与工具协议](../../../MCP与工具协议.md) |
| `07-eval` | 轨迹检查、规则评估、LLM-as-Judge | [10_Eval与测试体系](../../../10_Eval与测试体系.md) |

## 运行

```bash
# 在 ai-agent-learning/ 目录下执行
python3 -m venv .venv
